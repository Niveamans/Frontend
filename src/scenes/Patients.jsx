...
//   }
  ...
  useEffect(()=>{
   Promise.all([firebase.getDocument("patients",params.patient),firebase.getSubCollection("patients",params.patient,"checkups")])
  },[])
  ...
  return (
    ...
    {
      firebase.checkups.map((item)=><Checkup data={item}></Checkup>)
    }
